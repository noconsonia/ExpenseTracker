...
<br>
<button class="submit" style="margin-left: 50px"><a href="/admin/adduser">Add new user</a></button>
<button class="submit" style="margin-left: 50px"><a href="/admin/all">List of all users</a></button>
<br><br>
